...
An AI-native organizational system built around specialized agents, structured workflows, governance, memory, and task execution.

`AI Agents` `Automation` `Governance` `Systems`
...
```console
taha@taha-os:~$ robotics --results --selected
